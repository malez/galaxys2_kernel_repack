...
#define CONFIG_CMDLINE "root=/dev/mmcblk0p1 rw rootdelay=2 init=/init vram=15M omapfb.vram=0:5M androidboot.hardware=t1 switch_sel=3 androidboot.emmc_checksum=0 sec_debug.enable=1 sec_debug.enable_user=1 androidboot.debug_level=0x4f4c mem=512M@0x80000000 mem=512M@0xa0000000 vmalloc=144m console=sec_log_buf loglevel=7 androidboot.mode=power_key bootmode=0 sec_log=2052K@0x9fdff000 sec_bootfb=8M@0xaf800000 lcd_panel_id=1"
...
#define CONFIG_INITRAMFS_SOURCE "source/usr/i9100g_initramfs.list"
